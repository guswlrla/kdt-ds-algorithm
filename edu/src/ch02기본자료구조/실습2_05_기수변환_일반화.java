...
public class 실습2_05_기수변환_일반화 {
//교재 69~74 기수 변환하기 > 실습 2-6 코드 학습
	/*
	 * N 진법을 10진수로 변경후 M진법으로 변경
	 * 
	 * String: immutable(변경불가능) 객체, concat(), substring(), charAt(), equals(),
	 * compareTo() 등 문자열 조작과 비교를 위한 메서드 String s = "hello"; s = s + "world";
	 * 
	 * StringBuilder: mutable - 문자열이 자주 변경시 사용, append, insert, delete, reverse 함수
	 * 사용
	 * 
	 */
	// n진수를 10진수로 변환하는 함수
	public static int toDecimal(String number, int baseN) {
		/*
		 * charAt()를 사용하여 N 진법(baseN) 스트링을 10진수 바꾼다 0<= ch <= 9: num = ch - '0' ch > 9 :
		 * num = ch - 'A' + 10 로 계산
		 */
		int decimal = 0;
