...
//		 */
//		int result3Index = Arrays.binarySearch(arr, newFruit4, cc_name); // 클래스에 있는 걸 사용
//		System.out.println("\nArrays.binarySearch([수박,880,2023-5-18]) 조회결과::" + result3Index);
//		
//		result3Index = binarySearch(arr, newFruit4, cc_price);// 교재 113 binSearch() 함수를 고쳐서 직접 구현 
