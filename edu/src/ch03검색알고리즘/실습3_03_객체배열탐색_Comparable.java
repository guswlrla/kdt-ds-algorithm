...
class Fruit5 {
	...
	public Fruit5(String fruit, int price, String expire) {
		this.fruit = fruit;
		this.price = price;
		this.expire = expire;
	}
...
public class 실습3_03_객체배열탐색_Comparable {
	private static void showData(String string, Fruit5[] arr) {
	...
	public static void main(String[] args) {
		Fruit5[] arr = { new Fruit5("사과", 200, "2023-5-8"), new Fruit5("감", 500, "2023-6-8"),
