...
//public class 실습6_10_QuickSortStack {
...
//		// stack을 1개 사용한 버전으로 수정
//		Stack<Point> st = new Stack<>();
//		Point p = new Point(left, right);
//		st.push(p);
//
//		/*
//		 * IntStack lstack = new IntStack(right - left + 1); IntStack rstack = new
//		 * IntStack(right - left + 1);
//		 * 
//		 * lstack.push(left); rstack.push(right);
//		 */
//
