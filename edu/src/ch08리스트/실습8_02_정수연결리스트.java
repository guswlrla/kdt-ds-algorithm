...
//			Node1 q = null; // q는 p를 따라다님
//			while(p != null) {
//				if(element < first.data) { // 맨 앞에 넣을 경우 
//					if(p == first) {
//						newNode.link = p;
//						first = newNode;
//						return;
...
//}
//
//public class 실습8_02_정수연결리스트 {
//	enum Menu { // enum - 기수번호 부여, 클래스라고 생각
//		Add("삽입"), Delete("삭제"), Show("인쇄"), Search("검색"), Merge("합병"), Exit("종료"); // 0 ~ 5
//
