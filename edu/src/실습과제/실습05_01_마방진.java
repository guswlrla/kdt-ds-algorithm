//package assign;
//
//public class 실습5_1마방진 {
//	/*
//	 * 마방진: 마법 magic + 정방형 배열 + 배치 진열의 진 > 숫자를 특이하게 배열하여 모든 방향의 합이 일정 **매직 스퀘어(Magic
//	 * Square)**는 n×n 크기의 정사각형 배열에 숫자를 배치하되, 모든 행, 열, 대각선의 숫자 합이 동일하게 되는 배열을 말합니다.
//	 * 이때 이 동일한 합을 **매직 상수(Magic Constant)**라고 합니다. n은 3,5,7 등 홀수일 때
//	 */
//
