...
//}
//
//public class 실습6_1_MergeSort다항식정렬 {
...
//		Term[] x = { new Term(1.5, 3), new Term(2.5, 7), new Term(3.3, 2), new Term(4.0, 1), new Term(2.2, 0),
//				new Term(3.1, 4), new Term(3.8, 5), };
//		Term[] y = { new Term(1.5, 1), new Term(2.5, 2), new Term(3.3, 3), new Term(4.0, 0), new Term(2.2, 4),
